...
/**
 * Service Cookie 인증 샘플용으로 사용.
 * 
 * Utility class for managing the service user cookie that remembers the signed-in user.
 * @author Keith Donald
 */
public final class ServiceCookieGenerator {

	private final CookieGenerator userCookieGenerator = new CookieGenerator();

	public ServiceCookieGenerator() {
		userCookieGenerator.setCookieName("user_for_service");
	}
