/*
 * @(#)DaoConnectionRepository.java $version 2012. 1. 31.
 *
...
public class DaoConnectionRepository implements ConnectionRepository {
	...
	public DaoConnectionRepository(UserConnectionDAO userConnectionDAO, String userId, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
	...
	public List<Connection<?>> findConnections(String providerId) {
		...
		return userConnectionDAO.selectConnections(userId, providerId);
	}
	...
	public Connection<?> getConnection(ConnectionKey connectionKey) {
		try {
			...
			return userConnectionDAO.selectConnection(userId, connectionKey);
	...
	public void addConnection(Connection<?> connection) {
		try {
			...
			userConnectionDAO.insert(userId, data);
	...
	public void updateConnection(Connection<?> connection) {
		ConnectionData data = connection.createData();
		userConnectionDAO.update(userId, data);
	...
	private Connection<?> findPrimaryConnection(String providerId) {
		...
		List<Connection<?>> connections = userConnectionDAO.selectPrimaryConnection(userId, providerId);
